...
def main():
    ...
    raw_logs = [
        ...
        # Unknown Format: Proprietary Industrial Router
    ...
    # ---------------------------------------------------------
    console.rule("[bold magenta]Stage 2: Autonomous Agentic Control Plane (Ollama)[/bold magenta]")
    ...
    rprint("  • Extracting unknown pattern signatures and invoking Reflexion loop...")
